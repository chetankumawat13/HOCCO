  ...
  return (
    <div className='navbar'>
        ...
        <div className='nav-links'>
            ...
            <NavLink className={({isActive}) => isActive ? "active" :""} to='/ourBrands'>our brands</NavLink>
            <NavLink className={({isActive}) => isActive ? "active" :""} to='/ourProducts'>our products</NavLink>
